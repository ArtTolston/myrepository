...
void TestDatabaseFind() {
	/*{
		...
		AssertEqual(found1, vector<string>{
			 "work", "work", "work", "work" , "work" }, "find case 1");
	}*/
	{
		Database db;
		...
		vector<string> found1 = db.FindIf(predicate1);
		AssertEqual(found1, vector<string>{
			 "2017-06-01 sleep", "2017-06-02 sleep", "2017-06-03 sleep" , "2017-06-04 sleep", "2017-06-05 play computer games" ,
				 "2017-06-05 sleep" , "2017-06-06 visit parents", "2017-06-06 sleep" , "2017-06-07 sleep" , "2017-06-08 sleep" }, "find case 2");
	}
}
