...
public:
  explicit  Unit(geo2d::Point _position) : position(_position) {}
  ...
  public:
  explicit Building(geo2d::Rectangle geometry) : position(geometry) {}
  ...
  public:
  explicit Tower(geo2d::Circle geometry) : position(geometry) {}
  ...
  public:
  explicit Fence(geo2d::Segment geometry) : position(geometry) {}
